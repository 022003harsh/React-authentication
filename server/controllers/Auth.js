...
exports.signup = async (req, res) => {
  try {
    ...
    console.log("nai ho ra kya",Name,email,password,confirmPassword,accountType);
    if (
      !Name ||
      !email ||
      !password ||
    ...
    const user = await User.create({
      Name,
      email,  //doubt : contact number not written in the USER model
...
//   try {
//     const { email } = req.body //input field
...
//     const userDetails = await User.findById(req.user.id)  // we have added the id of the user in req.user see above in
